    ...
    $.fn.wondercarousellightbox = function(options) {
        ...
        inst.createMarkup = function() {
            ...
            if (inst.options.showsocial) {
                ...
                var socialBtnCSS = (inst.options.socialdirection == "horizontal" ? "display:inline-block;" : "display:none;") + "margin:4px;";
        ...
        inst.slideTimer =
            function(interval, callback, updatecallback) {
        ...
        inst.loadElem = function(elem) {
            ...
            inst.showing = true;
            if (inst.options.bodynoscroll) $("body").addClass("bodynoscroll");
            inst.showNavigation();
        ...
        inst.finish = function() {
            ...
            if (inst.options.bodynoscroll) $("body").removeClass("bodynoscroll");
            inst.slideTimeout.stop();
            inst.reset();
