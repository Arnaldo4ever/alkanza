...
function optionsframework_load_sanitization() {
	get_template_part('admin/options', 'sanitize');
}
...
function optionsframework_init() {
	...
	// Include the files
	get_template_part('admin/options', 'interface');
	get_template_part('admin/options', 'medialibrary-uploader');
	...
	// Change the capability to save the 'optionsframework' options group.
...
if ( !function_exists( 'optionsframework_add_page' ) ) {
	...
	function optionsframework_add_page() {
		$of_page = add_theme_page(esc_html__('Selfie', 'selfie'), esc_html__('Selfie', 'selfie'), 'edit_theme_options', 'options-framework','optionsframework_page');
		
		// Load the CSS and javscript
...
function optionsframework_load_scripts($hook) {
	...
	if ( !wp_script_is( 'wp-color-picker', 'registered' ) ) {
		...
		$colorpicker_l10n = array(
			'clear' => esc_html__( 'Clear' , 'selfie'),
			'defaultString' => esc_html__( 'Default' , 'selfie'),
			'pick' => esc_html__( 'Select Color' , 'selfie')
		);
...
function optionsframework_page() {
	...
	<div>
		<div id="optionsframework-metabox" class="metabox-holder">
			<div id="optionsframework-nav" class="nav-tab-wrapper">
				<div class="optionsframework-logo"><img src="<?php echo get_template_directory_uri(); ?>/admin/images/logo.png" /></div>				
				<?php echo optionsframework_tabs(); ?>
			</div>
			<div id="optionsframework" class="postbox">
				<form action="options.php" method="post">
				<input type="submit" class="button-primary button-primary-top" name="update" value="<?php esc_html_e( 'Save Options', 'selfie' ); ?>" />
				<?php settings_fields('optionsframework'); ?>
				<?php optionsframework_fields(); ?>
				<div id="optionsframework-submit">
					<input type="submit" class="button-primary" name="update" value="<?php esc_html_e( 'Save Options', 'selfie' ); ?>" />
					<div class="clear"></div>
				</div>
				</form>
			</div> <!-- / #container -->
...
function optionsframework_validate( $input ) {
	...
	if ( isset( $_POST['reset'] ) ) {
		add_settings_error( 'options-framework', 'restore_defaults', esc_html__( 'Default options restored.', 'selfie' ), 'updated fade' );
...
function optionsframework_save_options_notice() {
	add_settings_error( 'options-framework', 'save_options', esc_html__( 'Options saved.', 'selfie' ), 'updated fade' );
 ...
 * will not be found in this function's output.
 *
...
function optionsframework_adminbar() {
	...
	$wp_admin_bar->add_menu( array(
			'parent' => 'appearance',
			'id' => 'of_theme_options',
			'title' => esc_html__( 'Selfie', 'selfie' ),
...
if ( ! function_exists( 'of_get_option' ) ) {
	...
	function of_get_option( $name, $prof_default = false ) {
