...
function of_recognized_background_repeat() {
	$default = array(
		'no-repeat' => esc_html__('No Repeat', 'selfie'),
		'repeat-x'  => esc_html__('Repeat Horizontally', 'selfie'),
		'repeat-y'  => esc_html__('Repeat Vertically', 'selfie'),
		'repeat'    => esc_html__('Repeat All', 'selfie'),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => esc_html__('Top Left', 'selfie'),
		'top center'    => esc_html__('Top Center', 'selfie'),
		'top right'     => esc_html__('Top Right', 'selfie'),
		'center left'   => esc_html__('Middle Left', 'selfie'),
		'center center' => esc_html__('Middle Center', 'selfie'),
		'center right'  => esc_html__('Middle Right', 'selfie'),
		'bottom left'   => esc_html__('Bottom Left', 'selfie'),
		'bottom center' => esc_html__('Bottom Center', 'selfie'),
		'bottom right'  => esc_html__('Bottom Right', 'selfie')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => esc_html__('Scroll Normally', 'selfie'),
		'fixed'  => esc_html__('Fixed in Place', 'selfie')
		);
...
function of_recognized_font_styles() {
	$default = array(
		'normal'      => esc_html__('Normal', 'selfie'),
		'italic'      => esc_html__('Italic', 'selfie'),
		'bold'        => esc_html__('Bold', 'selfie'),
		'bold italic' => esc_html__('Bold Italic', 'selfie')
		);
