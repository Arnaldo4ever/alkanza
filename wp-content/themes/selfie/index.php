	...
	<div class="container selfie-header-container">
		<div class="col-md-12 item_bottom">
			...
			<div class="section-title item_bottom text-center">
				<span style="color:<?php echo selfie_get_option_value('top_title_icon_color'); ?>;" class="fa fa-home fa-2x"></span>
				<h1 style="color: <?php echo selfie_get_option_value('top_title_icon_color'); ?>;"><?php echo esc_attr(selfie_get_option_value('index_page_title')); ?></h1>
			</div>
			<!-- End Section title -->
		</div>
	</div>
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-8 col-sm-8" id="primary">
				<div class="blog-item">
					<?php
						$postBy = esc_html__("Posted by " , "selfie");
						$onString = esc_html__("on" , "selfie");
						$inString = esc_html__("in" , "selfie");
