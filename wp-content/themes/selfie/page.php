		...
		<div class="container selfie-header-container">
			<div class="col-md-12 item_bottom">
				...
				<div class="section-title item_bottom text-center">
					<span style="color:<?php echo esc_attr(selfie_get_option_value('top_title_icon_color')); ?>;" class="fa fa-shopping-cart fa-2x"></span>
					<h1 style="color: <?php echo esc_attr(selfie_get_option_value('top_title_icon_color')); ?>;"><?php echo get_the_title(); ?></h1>			
				</div>
				<!-- End Section title -->
			</div>
		</div>
	...
	<div id="single" class="fullwidth-section bg-callout title-section">
		<div class="container selfie-header-container">
			<div class="col-md-12 item_bottom">
				<!-- Section title -->
				<div class="section-title item_bottom text-center">
					<span style="color:<?php echo esc_attr(selfie_get_option_value('top_title_icon_color')); ?>;" class="fa fa-user fa-2x"></span>
					<h1 style="color: <?php echo esc_attr(selfie_get_option_value('top_title_icon_color')); ?>;"><?php echo get_the_title(); ?></h1>			
				</div>
				<!-- End Section title -->
			</div>
